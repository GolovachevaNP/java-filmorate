...
* events - события пользователей для ленты активности
...
* friendship_statuses - статусы дружбы между пользователями
* review_likes - лайки и дизлайки отзывов пользователей
### **Примеры запросов**
